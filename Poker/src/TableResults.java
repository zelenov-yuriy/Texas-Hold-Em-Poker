public class TableResults 
{
	...
	public static int Comparison(Combination comb1, Combination comb2)
	{
		...
		if(comb1.getNumType() > comb2.getNumType())
			result = 1;
		else if(comb1.getNumType() == comb2.getNumType())
		{
			switch(comb1.getNumType())
			{
			case 0:
	...
	public static int bestOfHighestCard(Combination comb1, Combination comb2)
	{
		...
		for(int i=4; i>=0; i--)
		{
			rank1 = comb1.getCard(i).getNumber()/4;
			rank2 = comb2.getCard(i).getNumber()/4;
			if(rank1 > rank2)
			{
				result = 1;
				break;
	...
	public static int bestOfPair(Combination comb1, Combination comb2)
	{
		...
		for(int i=0; i<5; i++)
		{
			rank = comb1.getCard(i).getNumber()/4;
			if(i < 4)
			{
				if(rank == comb1.getCard(i+1).getNumber()/4)
				{
					rankP1 = rank;
					i++;
				}
		...
		for(int i=0; i<5; i++)
		{
			rank = comb2.getCard(i).getNumber()/4;
			if(i < 4)
			{
				if(rank == comb2.getCard(i+1).getNumber()/4)
				{
					rankP2 = rank;
					i++;
				}
	...
	public static int bestOfStraight(Combination comb1, Combination comb2)
	{
		...
		if(comb1.getCard(0).getNumber()/4 == 0 && 
			comb1.getCard(4).getNumber()/4 == 12)
				rank1 = -1;
		else
				rank1 = comb1.getCard(0).getNumber()/4;
		if(comb2.getCard(0).getNumber()/4 == 0 && 
			comb2.getCard(4).getNumber()/4 == 12)
				rank2 = -1;
		else
				rank2 = comb2.getCard(0).getNumber()/4;
		if(rank1 > rank2)
			result = 1;
		else if(rank1 < rank2)
			result = -1;
	...
	public static int bestOfFlush(Combination comb1, Combination comb2)
	{
		...
		for(int i=0; i<5; i++)
		{
			rank1[i] = comb1.getCard(i).getNumber()/4;
			rank2[i] = comb2.getCard(i).getNumber()/4;
		}
		if(rank1[4] > rank2[4])
			result = 1;
	...
	public static int bestOfFullHouse(Combination comb1, Combination comb2)
	{
		...
		if(comb1.getCard(0).getNumber()/4 ==
			comb1.getCard(2).getNumber()/4)
		{
			rankT1 = comb1.getCard(0).getNumber()/4;
			rankP1 = comb1.getCard(3).getNumber()/4;
		}
		else
		{
			rankP1 = comb1.getCard(0).getNumber()/4;
			rankT1 = comb1.getCard(2).getNumber()/4;
		}
		if(comb2.getCard(0).getNumber()/4 ==
			comb2.getCard(2).getNumber()/4)
		{
			rankT2 = comb2.getCard(0).getNumber()/4;
			rankP2 = comb2.getCard(3).getNumber()/4;
		}
		else
		{
			rankP2 = comb2.getCard(0).getNumber()/4;
			rankT2 = comb2.getCard(2).getNumber()/4;
		}
		if(rankT1 > rankT2)
			result = 1;
		else if(rankT1 < rankT2)
	...
	public static int bestOfFour(Combination comb1, Combination comb2)
	{
		...
		if(comb1.getCard(0).getNumber()/4 ==
			comb1.getCard(3).getNumber()/4)
		{
			rankF1 = comb1.getCard(0).getNumber()/4;
			rankH1 = comb1.getCard(4).getNumber()/4;
		}
		else
		{
			rankH1 = comb1.getCard(0).getNumber()/4;
			rankF1 = comb1.getCard(1).getNumber()/4;
		}
		if(comb2.getCard(0).getNumber()/4 ==
			comb2.getCard(3).getNumber()/4)
		{
			rankF2 = comb2.getCard(0).getNumber()/4;
			rankH2 = comb2.getCard(4).getNumber()/4;
		}
		else
		{
			rankH2 = comb2.getCard(0).getNumber()/4;
			rankF2 = comb2.getCard(1).getNumber()/4;
		}
		if(rankF1 > rankF2)
			result = 1;
	...
	public static void main(String[] args)
	{
		...
		Combination[] combs = new Combination[5];
		
		Card[] comb0 = new Card[5];
		comb0[0] = new Card(21, "7", "Diamonds");
		comb0[1] = new Card(24, "8", "Clubs");
		comb0[2] = new Card(30, "9", "Hearts");
		comb0[3] = new Card(39, "Jack", "Spades");
		comb0[4] = new Card(46, "King", "Hearts");
		
		combs[4] = new Combination(comb0);
		
		determineWinCombs(winners, combs);
